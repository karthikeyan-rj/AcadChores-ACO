  ...
  return (
    <div className="p-6 space-y-5 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-theme">Plugin Marketplace</h1>
          <p className="text-xs text-theme-tertiary mt-0.5">No plugins available — plugin API not connected</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 text-theme-tertiary">
        <div className="w-16 h-16 rounded-2xl bg-surface border border-theme flex items-center justify-center mb-4">
          <Puzzle size={28} className="text-theme-tertiary" />
        </div>
